...
\be
\label{Ueq}
U \left[ \ba{cccc} \frac{2}{C} & & & \cr & \ddots & & \cr & & \frac{2}{C} & \cr & & & u D_{\{2/C - p'_i\}} u^\dagger \ea \right] U^\dagger = D_{\{2/B - p_i\}}
\ee
...
\be
\left( \frac{2}{ B} -\frac{2 }{ C}, \dots, \frac{2 }{ B} - \frac{2 }{ C}, \frac{2 }{ B} - p'_1, \dots, \frac{2 }{ B} - p'_{2B-C} \right)
\ee
The eigenvalues of the matrix on the left, ordered from smallest to largest, are
\be
\left( \frac{2 }{ C} - p'_1, \dots , \frac{2 }{ C} - p'_{2B-C}, \frac{2 }{ C}, \dots, \frac{2 }{ C} \right)
\ee
...
\be
\frac{2 }{ (N+1)K} \left(1, \dots, 1, \frac{N-1 }{ N}, \dots, \frac{N-1 }{ N},\dots, \frac{1 }{ N} \dots \frac{1}{ N}\right)
\ee
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \be
% \left[{\cal I} \, \, \, {\cal J} \right] = \sqrt{2 \over (n+1) K} \left[ \ba{cccc} U_1 & 
% & & \cr & U_2 & & \cr & & \ddots & \cr & & & U_n \ea \right] \left[ {\large 0}_{nK \times K} 
% \ba{cccc}  \sqrt{1 \over n} \identity_K & & & \cr & \sqrt{2 \over n} \identity_K & & \cr & 
% & \ddots & \cr & & & \identity_K \ea \right]
% \ee
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\be
\left[{\cal I} \, \, \, {\cal J} \right] = \sqrt{\frac{2}{(N+1) K}} \left[ \ba{cccc} U_1 & & & \cr & U_2 & & \cr & & \ddots & \cr & & & U_N \ea \right] \left[ {\large 0}_{NK \times K} \ba{cccc}  \sqrt{\frac{1}{N}} \identity_K & & & \cr & \sqrt{\frac{2}{N}} \identity_K & & \cr & & \ddots & \cr & & & \identity_K \ea \right]
\ee
...
% \ee
\be
|\Psi_{(2,NK,(N+1)K)} \rangle = \frac{1}{\sqrt{(N+1)K}} \sum_{i=1}^K \sum_{b=1}^N \left\{ \sqrt{N + 1 - \frac{b}{N}} |0 \rangle  \otimes  |b \; i \rangle  \otimes |b \; i \rangle + \sqrt{\frac{b}{N}}  |1 \rangle  \otimes|b \; i \rangle  \otimes |b+1 \; i \rangle \right\}
\ee
...
\be
|\Psi \rangle = \sum_{i=1}^A \frac{1}{\sqrt{kA}} (M_i)_{bc} |i \rangle  \otimes |b \rangle  \otimes |c \rangle \; ,
\ee
...
\bibitem[HCRLL]{Helwig:2012nha}
  ...
  %%CITATION = doi:10.1103/PhysRevA.86.052335;%%
  %9 citations counted in INSPIRE as of 08 Jan 2018)
...
\bibitem[PYHP15]{Pastawski:2015qua} 
